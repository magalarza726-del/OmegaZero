...
import { structureBoardEditorMethods } from './features/structureBoardEditor.js';
...
class App{
 ...
 render(){
  ...
  this.bindGlobal();
  try{
   const renderer={home:'renderHome',setup:'renderSetup',game:'renderGame',analysis:'renderAnalysis',strategy:'renderStrategy',customize:'renderCustomize',library:'renderLibrary',stockfishTransform:'renderStockfishTransform',stockfishGraph:'renderStockfishGraph',tcomLab:'renderTComLab',energyAnalysis:'renderEnergyAnalysis',amongUsChess:'renderAmongUsChess',structureStudy:'renderStructureStudy',structureFamilies:'renderStructureFamilies',freeStructures:'renderFreeStructures',structureBoardEditor:'renderStructureBoardEditor',pawnGallery:'renderPawnGallery'}[this.screen];
