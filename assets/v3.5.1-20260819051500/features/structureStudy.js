...
export const structureStudyMethods={
 renderStructureStudy(){
  ...
  <section class="structure-study-grid">
   ...
   <button type="button" data-structure-kind="editor" class="structure-study-card editor"><div class="structure-card-icon">♔♕♖♗♘♙</div><small>POSICIÓN COMPLETA</small><h2>Editor de tablero</h2><p>Coloca piezas blancas y negras libremente. Analiza Acción o Subacción de un solo bando a la vez, sin generar familias.</p><span>Acción/Subacción · Blancas/Negras</span></button>
  </section>`;
  ...
  $$('[data-structure-kind]').forEach(button=>button.addEventListener('click',()=>{
    ...
    if(kind==='editor'){this.screen='structureBoardEditor';this.render();return}
