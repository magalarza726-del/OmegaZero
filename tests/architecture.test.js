...
const asset=join(repo,'assets','v3.2.0-20260816035000');
...
test('main.js es composition root y las áreas están modularizadas',()=>{
  ...
  for(const module of ['appChrome','board','play','learn','library','pawnGallery','structureStudy','energyAnalysis','tcom','transform']){
...
test('Estudiar estructuras ofrece vista Lista y Galería persistente',()=>{
  for(const module of ['pawnGallery','structureStudy']){
...
test('la página de producción apunta solo al build v3',()=>{
  ...
  assert.ok(html.includes('v3.2.0-20260816035000'));
